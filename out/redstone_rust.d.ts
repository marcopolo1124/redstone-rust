...
* @param {bigint} y
*/
  append(blk_type: string, orientation: number, x: bigint, y: bigint): void;
}
...
export interface InitOutput {
  ...
  readonly savedata_new: () => number;
  readonly savedata_append: (a: number, b: number, c: number, d: number, e: number, f: number) => void;
  readonly run: () => void;
